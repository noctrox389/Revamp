...
idle_xml_name = 'idle'
left_xml_name = 'singRIGHT'
down_xml_name = 'singDOWN'
up_xml_name = 'singUP'
right_xml_name = 'singLEFT'
...
name_of_character_xml = 'Sunky'
name_of_character = 'sunky'
name_of_notetype = 'sunkynote'
name_of_notetype2 = 'sunky and bf' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
